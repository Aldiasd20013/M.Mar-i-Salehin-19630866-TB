...
private void Frmpengunjung(String fileName) {
	...
	refresh();
	try {
		if (btampil.getText().equals("Cetak Data pengunjung") == true) {
		Frmpengunjung("lap_kunjung.jasper");
		/* } else if (btampil.getText().equals("AAAA") == true){
		Frmpengunjung("AAA.jasper");
		 } else if (btampil.getText().equals("AAAA") == true){
		Frmpengunjung("AAA.jasper");
		 } else if (btampil.getText().equals("AAAA") == true){
		Frmpengunjung("AAA.jasper");
